...
const extract_facts: Operation = {
  ...
  params: {
    ...
    entity_hints: { type: 'array', items: { type: 'string' }, description: 'Existing canonical entity slugs the agent has already resolved. Helps the extractor pick the right slug. HTTP MCP also accepts a JSON array string or comma-separated list.' },
