...
export async function runThink(
  ...
  // Render evidence blocks for the prompt. Fork: force-include the anchor
  // page (when --anchor resolved to a real page) ahead of the hybrid hits so
  // the requested entity's compiled truth is always in the synthesis prompt.
